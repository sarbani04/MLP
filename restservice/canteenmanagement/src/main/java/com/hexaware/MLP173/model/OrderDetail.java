 ...
 */
  ...
  public final String toString() {
    return String.format("%5s %10s %5s %10s %10s %10s %10s %10s %10s %10s %10s", ordId, ordTime, ordAmount, ordLocation, ordStatus, qtyOrder,
        cusId, foodId, venId, walType, ordComments);
  }
}
